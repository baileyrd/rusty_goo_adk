...
[GitHub Security Advisories](https://github.com/baileyrd/rusty_goo_adk/security/advisories/new),
or reach the repo owner, [@baileyrd](https://github.com/baileyrd), directly if advisories aren't set up on this repo yet.
